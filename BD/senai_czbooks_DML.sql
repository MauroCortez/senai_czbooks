...
INSERT INTO Usuario					(Usuario, Email, Senha, idTipoUsuario)
...
o rapaz conhece uma bela garota chamada Chizuru Mizuhara e a vida dos dois começa a mudar a partir daí.', 'Romance', 6, '2018-12-28', 'R$27,64', 1)
...
Porém, os métodos que ela usa são totalmente inapropriados. Harry, então, se reúne com um grupo de alunos para defender sua escola.', 'Fantasia', 7, '2017-08-19', 'R$48,50', 1)
...
Para tornar a obra mais didática foram elaborados diagramas, sintetizando a demonstração dos procedimentos apontados nos modelos de documentos da Polícia Judiciária.', 'Policial', 8, '2018-12-28', 'R$42,56', 1)
...
Para salvar o amigo, Alice deve conversar com o Tempo para voltar às vésperas de um evento traumático e mudar seus destinos cruéis.', 'Aventura', 9, '2021-04-07', 'R$42,90', 1)
;